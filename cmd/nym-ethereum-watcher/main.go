// main.go - ethereum-watcher entrypoint.
...
`
	...
	info := map[string]string{
		"run": "Run a persistent nym ethereum watcher",
	}
	optparse.Commands("nym-ethereum-watcher", "0.12.8", cmds, info, logo)
}
